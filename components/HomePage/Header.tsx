	...
	return (
		<header className='flex justify-center items-center flex-col relative w-screen h-screen p-4'>
			...
			<div className='flex flex-col justify-center items-center z-10'>
				<h1 className='text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold'>Witaj na naszej stronie!</h1>
				<p className='mt-4 text-center text-md sm:text-xl text-white opacity-70'>
					Oferujemy wsparcie w skutecznym zarządzaniu produkcją od posadzenia pierwszej sadzonki aż do ostatniego
					zbioru!
				</p>
